...
const linkChordsListen = document.querySelectorAll('.chords-listen-menu')
const linkIntervalsListen = document.querySelectorAll('.intervals-listen-menu')
const linkScalesListen = document.querySelectorAll('.scales-listen-menu')
const linkChordsSing = document.querySelectorAll('.chords-sing-menu')
const linkIntervalsSing = document.querySelectorAll('.intervals-sing-menu')
const linkScalesSing = document.querySelectorAll('.scales-sing-menu')
